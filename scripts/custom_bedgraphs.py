...
def read_modkit(modkit_output):
    ...
    # Total coverage include also the modification below threshold and other bases! It is more accurate. 
    ...
    d["fraction_modified"] = d["fraction_modified"] / 100  # this is the value computed by modkit
